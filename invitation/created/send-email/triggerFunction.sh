...
curl -X POST \
  ...
  -d '{"data":{"Invitation":{"updatedFields":["updatedAt"],"node":{"id":"cj6z8dyp800033i5xfn8xc2h5","email":"string","project":{"id":"cj6z8dyp800043i5xutcm2717","name":"TEST"}}}},"context":{"request":{"sourceIp":"test-ip","headers":{},"httpMethod":"post"},"graphcool":{"pat":"test-pat","projectId":"test-project-id","alias":"test-alias"},"environment":{},"auth":{"nodeId":"test-node-id","typeName":"test-type","token":"test-token"},"sessionCache":{}}}'